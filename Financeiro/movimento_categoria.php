...
$consulCategoria = $daoCat->consultarCategoria();
...
if (isset($_POST['btnPesquisar'])) {
    ...
    $movs = $dao->filtrarMovimentoCategoria($categoria, $data_inicial, $data_final);
    $consulCategoria = $daoCat->consultarCategoria();
} 
?>
<!DOCTYPE html>
            ...
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <h2>Consultar Movimentos por Categorias</h2>
                        <h5>Consulta todos os movimentos em uma determinada Categoria. </h5>

                    </div>
                </div>
                <!-- /. ROW  -->
                <hr />
                <form action="movimento_categoria.php" method="post">
                    <div class="form-group col-md-12" id="categoria">
                        <label>Categoria</label>
                        <select class="form-control" name="categoria">
                        <option value="">Selecione...</option>
                            <?php foreach($consulCategoria as $item) {?>
