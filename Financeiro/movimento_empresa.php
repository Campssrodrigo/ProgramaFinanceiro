...
$daoCat = new EmpresaDAO();
$consulEmpresa = $daoCat->consultarEmpresa();
...
if (isset($_POST['btnPesquisar'])) {
    ...
    $movs = $dao->filtrarMovimentoEmpresa($empresa, $data_inicial, $data_final);
    $consulEmpresa = $daoCat->consultarEmpresa();
} 
?>
<!DOCTYPE html>
            ...
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <h2>Consultar Movimentos por Empresas</h2>
                        <h5>Consulta todos os movimentos em uma determinada Empresa. </h5>

                    </div>
                </div>
                <!-- /. ROW  -->
                <hr />
                <form action="movimento_empresa.php" method="post">
                    <div class="form-group col-md-12" id="empresa">
                        <label>Tipo de Empresa</label>
                        <select class="form-control" name="empresa">
                        <option value="">Selecione...</option>
                            <?php foreach($consulEmpresa as $item) {?>
